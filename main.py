...
def total():
    ...
    totalCosPrice = float(soap + faceCream + faceWash + hairSpray + hairgel + bodyLotion)
    cosmeticPriceEntry.delete(0, END)
    cosmeticPriceEntry.insert(
        0, f'{totalCosPrice:.2f} Rs'
    ...
    totalBill=totalCosPrice+totalDrinkPrice+totalGroceryPrice+cosmeticTax+groceryTax+coolDrinkTax
